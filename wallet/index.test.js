...
const {INITIIAL_BALANCE} = require('../config');
...
describe('Wallet', () =>{
    ...
    describe('calculating a balance',()=>{
        ...
        it('calculate the balance for blockchain transaction matching the recipient',()=>{
            expect(wallet.calculateBalance(bc)).toEqual( INITIIAL_BALANCE + (addBalance*repeatAdd));
        });

        it('calculate the balance for blockchain transactions matching the sender',()=>{
            expect(senderWallet.calculateBalance(bc)).toEqual( INITIIAL_BALANCE - ( addBalance * repeatAdd));
        });
